...
public class AdapterList extends ArrayAdapter<Row_List_View_object> {

	public AdapterList(ArrayList<Row_List_View_object> array) {
		...
		public void fill(final ArrayAdapter<Row_List_View_object> adapter, final Row_List_View_object item, final int position) {
			...
			LayoutRoot.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if (Newsit.isOnline()) {
						Intent intent = new Intent(Newsit.currentActivity, Show_web.class);
						intent.putExtra("POSITION", position);
						Newsit.currentActivity.startActivity(intent);
					}
					else {
